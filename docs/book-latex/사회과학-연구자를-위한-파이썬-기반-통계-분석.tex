...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomrule=.15mm, coltitle=black, breakable, bottomtitle=1mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{📌 핵심 요약}, colframe=quarto-callout-note-color-frame, rightrule=.15mm, leftrule=.75mm, colback=white, titlerule=0mm, arc=.35mm, toptitle=1mm, left=2mm, opacitybacktitle=0.6]
